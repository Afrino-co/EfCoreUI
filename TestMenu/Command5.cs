...
namespace TestMenu
{
    ...
    internal sealed class Command5
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("b9fdc572-d383-47c7-b10d-92022cfa21e6");
        ...
        private Command5(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        {
            // Switch to the main thread - the call to AddCommand in Command5's constructor requires
            // the UI thread.
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);

            OleMenuCommandService commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new Command5(package, commandService);
        }
